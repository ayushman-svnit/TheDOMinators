...
export function TransportSimulator({ city, time, destination, transportModes, calculatedDistance }) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      setResults(simulatedResults.sort((a, b) => Number.parseInt(a.eta) - Number.parseInt(b.eta)))
      setLoading(false)
    }, 2000)
  ...
  const generateETA = (modeId) => {
    ...
    return finalTime > 60 ? `${Math.round(finalTime / 60)}h ${finalTime % 60}m` : `${finalTime} min`
  }
  ...
  const generateRoute = (city, dest) => {
    return [`${city} Hub`, "AI Traffic Grid", "Smart Junction Alpha", `${dest} Terminal`]
  }
        ...
        <Card className="bg-black/20 border-blue-500/30">
          <CardContent className="p-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-400">Analyzing traffic patterns, weather, and optimal routes...</p>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
            <div>
              ...
              <p className="text-white font-semibold">{calculatedDistance.toLocaleString()} km</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-cyan-400 font-semibold">{results[0]?.mode.name || "Calculating..."}</p>
            </div>
          </div>
        </CardContent>
      </Card>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-white text-lg">{result.mode.name}</CardTitle>
                      {index === 0 && <Badge className="bg-green-500/20 text-green-400 text-xs">AI Recommended</Badge>}
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-green-400 font-semibold">{result.carbonSaved}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-400 font-semibold">{result.costComparison}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
