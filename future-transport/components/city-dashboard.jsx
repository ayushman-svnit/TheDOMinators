...
import { Activity, Car, Zap, TrendingUp, AlertTriangle, CheckCircle, Clock } from "lucide-react"
...
export function CityDashboard() {
  ...
  const [alerts, setAlerts] = useState([
    { id: 1, type: "info", message: "Weather rerouting activated in Sector 7", time: "2 min ago" },
    { id: 2, type: "success", message: "Traffic flow optimized - 15% improvement", time: "5 min ago" },
    { id: 3, type: "warning", message: "High demand detected in downtown area", time: "8 min ago" },
  ])
